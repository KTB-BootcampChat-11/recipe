...
# =============================================================================
VAD_SAMPLE_RATE = 16000  # Silero VAD 요구사항 (16kHz)
VAD_MIN_SPEECH_DURATION = 0.5  # 최소 발화 구간 (초)
VAD_MIN_SILENCE_DURATION = 0.3  # 최소 무음 구간 (초)
VAD_SPEECH_PAD_MS = 100  # 발화 구간 앞뒤 패딩 (ms)
VAD_MAX_SEGMENT_DURATION = 30  # 최대 세그먼트 길이 (초)
